...
func phase3LegacyFixture() *opengraph.Graph {
	return &opengraph.Graph{
		...
		Edges: []opengraph.Edge{
			...
			{StartID: "late-a", EndID: "late-b", Kind: "CandidateRel", Properties: map[string]any{"lastseen": phase3Day(3), "marker": "candidate-equal"}},
			{StartID: "late-a", EndID: "late-b", Kind: "CandidateRel", Properties: map[string]any{"lastseen": phase3Day(4), "marker": "candidate-new"}},
			{StartID: "late-a", EndID: "late-b", Kind: "CandidateRel", Properties: map[string]any{"marker": "candidate-missing"}},
			{StartID: "late-a", EndID: "late-b", Kind: "CandidateRel", Properties: map[string]any{"lastseen": nil, "marker": "candidate-null"}},
			{StartID: "late-a", EndID: "late-b", Kind: "HasSession", Properties: map[string]any{"marker": "session-missing"}},
			{StartID: "late-a", EndID: "late-b", Kind: "HasSession", Properties: map[string]any{"lastseen": nil, "marker": "session-null"}},
			{StartID: "late-a", EndID: "late-b", Kind: "HasSession", Properties: map[string]any{"lastseen": phase3Day(2), "marker": "session-old"}},
			{StartID: "late-a", EndID: "late-b", Kind: "HasSession", Properties: map[string]any{"lastseen": phase3Day(3), "marker": "session-equal"}},
			{StartID: "late-a", EndID: "late-b", Kind: "HasSession", Properties: map[string]any{"lastseen": phase3Day(4), "marker": "session-new"}},
...
func phase3BatchFixture(fanout int) *opengraph.Graph {
	fixture := &opengraph.Graph{
		...
		Edges: []opengraph.Edge{
			...
			{StartID: "rel-a", EndID: "rel-b", Kind: "PruneDelete", Properties: map[string]any{"marker": "many-a"}},
