...
func TestPropertyLookupEqualityScalarRewrites(t *testing.T) {
	var (
		...
		testCases = []struct {
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'isassignabletorole')) = @__strlit0::text and (n.properties ->> 'isassignabletorole') = @__strlit1::text)",
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'isassignabletorole')) = @__strlit0::text and @__strlit1::text = (n.properties ->> 'isassignabletorole'))",
			ExpectedParams: map[string]any{"__strlit0": "string", "__strlit1": "true"},
		}, {
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'rank')) = @__strlit0::text and (n.properties ->> 'rank') = @__strlit1::text)",
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'objectid')) = @__strlit0::text and (n.properties ->> 'objectid') = @pi0::text)",
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'distinguishedname')) = @__strlit0::text and (n.properties ->> 'distinguishedname') = upper(@__strlit1::text)::text)",
			...
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'distinguishedname')) = @__strlit0::text and upper(@__strlit1::text)::text = (n.properties ->> 'distinguishedname'))",
			ExpectedParams: map[string]any{"__strlit0": "string", "__strlit1": "admin"},
		}, {
			...
			ROperand:       mustAsLiteral("1"),
			ExpectedSql:    "(jsonb_typeof((n.properties -> 'rank')) = @__strlit0::text and (n.properties ->> 'rank') <> @__strlit1::text or jsonb_typeof((n.properties -> 'rank')) <> @__strlit0::text and (n.properties -> 'rank') <> to_jsonb((@__strlit1::text)::text)::jsonb)",
			ExpectedParams: map[string]any{"__strlit0": "string", "__strlit1": "1"},
		}, {
			...
			Operator:       pgsql.OperatorEquals,
			ROperand:       mustAsLiteral(true),
			ExpectedSql:    "((n.properties -> 'isassignabletorole'))::jsonb = to_jsonb((true)::bool)::jsonb",
			ExpectedParams: map[string]any{},
		}, {
			...
			Operator:       pgsql.OperatorEquals,
			ROperand:       mustAsLiteral(1),
			ExpectedSql:    "((n.properties -> 'count'))::jsonb = to_jsonb((1)::int8)::jsonb",
			ExpectedParams: map[string]any{},
		}, {
			...
			ExpectedSql:    "(n.properties -> 'left') = (n.properties -> 'right')",
			ExpectedParams: map[string]any{},
		}}
	)
