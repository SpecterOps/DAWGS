...
-- pgsql_params:{"__strlit0":"EdgeKind2"}
...
-- pgsql_params:{"__strlit0":"EdgeKind%"}
...
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0 from edge e0 join node n1 on (jsonb_typeof((n1.properties -> @__strlit0::text)) = @__strlit1::text and (n1.properties ->> @__strlit0::text) = @__strlit2::text) and n1.id = e0.end_id join node n0 on n0.id = e0.start_id where e0.kind_id = any (array [3]::int2[])) select count(s0.e0)::int8 as the_count from s0;
...
-- pgsql_params:{"__strlit0":"objectid","pi0":1,"pi1":2,"pi2":"123","pi3":"456"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n1 on n1.id = e0.end_id join node n0 on (not (n0.id = @pi1::float8)) and n0.id = e0.start_id where ((e0.kind_id = any (array [3]::int2[]) or e0.kind_id = any (array [4]::int2[]))) and (not (cypher_ends_with((n0.properties ->> @__strlit0::text), (@pi2::text)::text)::bool or cypher_ends_with((n1.properties ->> @__strlit0::text), (@pi3::text)::text)::bool) and n1.id = @pi0::float8)) select distinct (s0.n0).id, (s0.e0).id, (s0.n1).id from s0;

-- case: match (s)-[r]->(e) where s.name = '123' and e:NodeKind1 and not r.property return s, r, e
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"123","__strlit3":"property"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n0 on ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text)) and n0.id = e0.start_id join node n1 on (n1.kind_ids operator (pg_catalog.@>) array [1]::int2[]) and n1.id = e0.end_id where (not ((e0.properties ->> @__strlit3::text))::bool)) select s0.n0 as s, s0.e0 as r, s0.n1 as e from s0;

-- case: match ()-[r]->() where r.value = 42 return r
-- pgsql_params:{"__strlit0":"value"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0 from edge e0 join node n0 on n0.id = e0.start_id join node n1 on n1.id = e0.end_id where (((e0.properties -> @__strlit0::text))::jsonb = to_jsonb((42)::int8)::jsonb)) select s0.e0 as r from s0;

-- case: match ()-[r]->() where r.bool_prop return r
-- pgsql_params:{"__strlit0":"bool_prop"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0 from edge e0 join node n0 on n0.id = e0.start_id join node n1 on n1.id = e0.end_id where (((e0.properties ->> @__strlit0::text))::bool)) select s0.e0 as r from s0;

-- case: match (n)-[r]->() where n.name = '123' return n, r
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"123"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from edge e0 join node n0 on ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text)) and n0.id = e0.start_id join node n1 on n1.id = e0.end_id) select s0.n0 as n, s0.e0 as r from s0;

-- case: match (n:NodeKind1)-[r]->() where n.name = '123' or n.name = '321' or n.name = '222' or n.name = '333' return n, r
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"123","__strlit3":"321","__strlit4":"222","__strlit5":"333"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from edge e0 join node n0 on ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text) or (jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit3::text) or (jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit4::text) or (jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit5::text)) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] and n0.id = e0.start_id join node n1 on n1.id = e0.end_id) select s0.n0 as n, s0.e0 as r from s0;

-- case: match (s)-[r]->(e) where s.name = '123' and e.name = '321' return s, r, e
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"123","__strlit3":"321"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n0 on ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text)) and n0.id = e0.start_id join node n1 on ((jsonb_typeof((n1.properties -> @__strlit0::text)) = @__strlit1::text and (n1.properties ->> @__strlit0::text) = @__strlit3::text)) and n1.id = e0.end_id) select s0.n0 as s, s0.e0 as r, s0.n1 as e from s0;

-- case: match (f), (s)-[r]->(e) where not f.bool_field and s.name = '123' and e.name = '321' return f, s, r, e
-- pgsql_params:{"__strlit0":"bool_field","__strlit1":"name","__strlit2":"string","__strlit3":"123","__strlit4":"321"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not ((n0.properties ->> @__strlit0::text))::bool)), s1 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1, (n2.id, n2.kind_ids, n2.properties)::nodecomposite as n2 from s0, edge e0 join node n1 on ((jsonb_typeof((n1.properties -> @__strlit1::text)) = @__strlit2::text and (n1.properties ->> @__strlit1::text) = @__strlit3::text)) and n1.id = e0.start_id join node n2 on ((jsonb_typeof((n2.properties -> @__strlit1::text)) = @__strlit2::text and (n2.properties ->> @__strlit1::text) = @__strlit4::text)) and n2.id = e0.end_id) select s1.n0 as f, s1.n1 as s, s1.e0 as r, s1.n2 as e from s1;
...
-- pgsql_params:{"__strlit0":"prop","__strlit1":"string","__strlit2":"a"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from edge e0 join node n0 on n0.id = e0.start_id join node n1 on n1.id = e0.end_id where (jsonb_typeof((e0.properties -> @__strlit0::text)) = @__strlit1::text and (e0.properties ->> @__strlit0::text) = @__strlit2::text) and e0.kind_id = any (array [3]::int2[])) select s0.n0 as s from s0 where ((with s1 as (select s0.e0 as e0, s0.n0 as n0 from edge e0 join node n2 on n2.id = (s0.e0).end_id where (s0.n0).id = (s0.e0).start_id) select count(*) > 0 from s1));

-- case: match (s)-[r:EdgeKind1]->(e) where not (s.system_tags contains 'admin_tier_0') and id(e) = 1 return id(s), labels(s), id(r), type(r)
-- pgsql_params:{"__strlit0":"system_tags","__strlit1":"","__strlit2":"%admin\\_tier\\_0%"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n1 on (n1.id = 1) and n1.id = e0.end_id join node n0 on (not (coalesce((n0.properties ->> @__strlit0::text), @__strlit1::text)::text like @__strlit2::text)) and n0.id = e0.start_id where e0.kind_id = any (array [3]::int2[])) select (s0.n0).id, (array(select _kind.name from generate_subscripts((s0.n0).kind_ids, 1) as _kind_idx, kind _kind where _kind.id = ((s0.n0).kind_ids)[_kind_idx] order by _kind_idx))::text[], (s0.e0).id, kind_name((s0.e0).kind_id)::text from s0;

-- case: match (s)-[r]->(e) where s:NodeKind1 and toLower(s.name) starts with 'test' and r:EdgeKind1 and id(e) in [1, 2] return r limit 1
-- pgsql_params:{"__strlit0":"name","__strlit1":"test%"}
with s0 as (select (e0.id, e0.start_id, e0.end_id, e0.kind_id, e0.properties)::edgecomposite as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n0 on (n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] and lower((n0.properties ->> @__strlit0::text))::text like @__strlit1::text) and n0.id = e0.start_id join node n1 on (n1.id = any (array [1, 2]::int8[])) and n1.id = e0.end_id where (e0.kind_id = any (array [3]::int2[])) limit 1) select s0.e0 as r from s0 limit 1;
