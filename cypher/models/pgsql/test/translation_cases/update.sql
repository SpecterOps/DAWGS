...
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"1234","__strlit3":"is_target"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text))), s1 as (update node n1 set properties = n1.properties || jsonb_build_object(@__strlit3::text, true)::jsonb from s0 where (s0.n0).id = n1.id returning (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n0) select 1;

-- case: match (n) where n.name = '1234' match (e) where e.tag = n.tag_id set e.is_target = true
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"1234","__strlit3":"tag","__strlit4":"tag_id","__strlit5":"is_target"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text))), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1 where ((n1.properties -> @__strlit3::text) = ((s0.n0).properties -> @__strlit4::text))), s2 as (update node n2 set properties = n2.properties || jsonb_build_object(@__strlit5::text, true)::jsonb from s1 where (s1.n1).id = n2.id returning s1.n0 as n0, (n2.id, n2.kind_ids, n2.properties)::nodecomposite as n1) select 1;
...
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"n3","__strlit3":"RENAMED"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text))), s1 as (update node n1 set properties = n1.properties || jsonb_build_object(@__strlit0::text, @__strlit3::text)::jsonb from s0 where (s0.n0).id = n1.id returning (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n0) select s1.n0 as n from s1;

-- case: match (n), (e) where n.name = 'n1' and e.name = 'n4' set n.name = e.name set e.name = 'RENAMED'
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"n1","__strlit3":"n4","__strlit4":"RENAMED"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text))), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1 where ((jsonb_typeof((n1.properties -> @__strlit0::text)) = @__strlit1::text and (n1.properties ->> @__strlit0::text) = @__strlit3::text))), s2 as (update node n2 set properties = n2.properties || jsonb_build_object(@__strlit0::text, ((s1.n1).properties -> @__strlit0::text))::jsonb from s1 where (s1.n0).id = n2.id returning (n2.id, n2.kind_ids, n2.properties)::nodecomposite as n0, s1.n1 as n1), s3 as (update node n3 set properties = n3.properties || jsonb_build_object(@__strlit0::text, @__strlit4::text)::jsonb from s2 where (s2.n1).id = n3.id returning s2.n0 as n0, (n3.id, n3.kind_ids, n3.properties)::nodecomposite as n1) select 1;
...
-- pgsql_params:{"__strlit0":"name","__strlit1":"string","__strlit2":"n1","__strlit3":"visited"}
with s0 as (select e0.id as e0, (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from edge e0 join node n0 on ((jsonb_typeof((n0.properties -> @__strlit0::text)) = @__strlit1::text and (n0.properties ->> @__strlit0::text) = @__strlit2::text)) and n0.id = e0.start_id join node n1 on n1.id = e0.end_id), s1 as (select s0.e0 as e0, (e1.id, e1.start_id, e1.end_id, e1.kind_id, e1.properties)::edgecomposite as e1, s0.n0 as n0, s0.n1 as n1 from s0 join edge e1 on (s0.n1).id = e1.start_id join node n2 on n2.id = e1.end_id where e1.id != s0.e0), s2 as (update edge e2 set properties = e2.properties || jsonb_build_object(@__strlit3::text, true)::jsonb from s1 where (s1.e1).id = e2.id returning s1.e0 as e0, (e2.id, e2.start_id, e2.end_id, e2.kind_id, e2.properties)::edgecomposite as e1, s1.n0 as n0, s1.n1 as n1) select ((s2.e1).properties -> @__strlit0::text) from s2;
