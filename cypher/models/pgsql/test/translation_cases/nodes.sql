...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (coalesce((n0.properties ->> 'name'), @__strlit0::text)::text = @__strlit1::text)) select s0.n0 as n from s0;

-- case: match (n) where n.name = '1234' return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"1234"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.`a-aaa` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'a-aaa')) = @__strlit0::text and (n0.properties ->> 'a-aaa') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.`b_bbb` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'b_bbb')) = @__strlit0::text and (n0.properties ->> 'b_bbb') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.`has``tick` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'has`tick')) = @__strlit0::text and (n0.properties ->> 'has`tick') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.`'` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> '''')) = @__strlit0::text and (n0.properties ->> '''') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.```starts-tick` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> '`starts-tick')) = @__strlit0::text and (n0.properties ->> '`starts-tick') = @__strlit1::text))) select s0.n0 as n from s0;

-- case: match (n) where n.```super-wrapped``` = "123" return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> '`super-wrapped`')) = @__strlit0::text and (n0.properties ->> '`super-wrapped`') = @__strlit1::text))) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] and (jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @__strlit1::text)) select s0.n0 as n from s0;

-- case: match (n:NodeKind1 {`'`: 'value'}) return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"value"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] and (jsonb_typeof((n0.properties -> '''')) = @__strlit0::text and (n0.properties ->> '''') = @__strlit1::text)) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @pi0::text))) select s0.n0 as s from s0;
...
-- pgsql_params:{"__strlit0":"string","__strlit1":"1234"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @__strlit1::text))) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @__strlit1::text))), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1) select s1.n0 as s, ((s1.n1).properties -> 'name') as othername from s1;

-- case: match (s) where s.name in ['option 1', 'option 2'] return s
-- pgsql_params:{"__strlit0":"option 1","__strlit1":"option 2"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((n0.properties ->> 'name') = any (array [@__strlit0::text, @__strlit1::text]::text[]))) select s0.n0 as s from s0;

-- case: match (s) where toLower(s.name) = '1234' return distinct s
-- pgsql_params:{"__strlit0":"1234"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (lower((n0.properties ->> 'name'))::text = @__strlit0::text)) select distinct s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((n0.properties ? 'system_tags' and not (n0.properties -> 'system_tags') = (@__strlit0::text)::jsonb) and not (n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] or n0.kind_ids operator (pg_catalog.@>) array [2]::int2[]))) select (s0.n0).id from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties ->> 'created_at'))::time without time zone = (@__strlit0::text)::time without time zone)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties ->> 'created_at'))::timestamp without time zone = current_date::date - @__strlit0::interval)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties ->> 'created_at'))::date = (@__strlit0::text)::date)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties ->> 'created_at'))::timestamp with time zone = (@__strlit0::text)::timestamp with time zone)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties ->> 'created_at'))::timestamp without time zone = (@__strlit0::text)::timestamp without time zone)) select s0.n0 as s from s0;

-- case: match (s) where not (s.name = '123') return s
-- pgsql_params:{"__strlit0":"string","__strlit1":"123"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not ((jsonb_typeof((n0.properties -> 'name')) = @__strlit0::text and (n0.properties ->> 'name') = @__strlit1::text)))) select s0.n0 as s from s0;

-- case: match (s) where s.isassignabletorole = 'true' return s
-- pgsql_params:{"__strlit0":"string","__strlit1":"true"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'isassignabletorole')) = @__strlit0::text and (n0.properties ->> 'isassignabletorole') = @__strlit1::text))) select s0.n0 as s from s0;
...
-- pgsql_params:{"__strlit0":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((not n0.properties ? 'created_at' or (n0.properties -> 'created_at') = (@__strlit0::text)::jsonb))) select s0.n0 as s from s0;

-- case: match (s) where s.created_at is not null return s
-- pgsql_params:{"__strlit0":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((n0.properties ? 'created_at' and not (n0.properties -> 'created_at') = (@__strlit0::text)::jsonb))) select s0.n0 as s from s0;

-- case: match (s) where s.name starts with '123' return s
-- pgsql_params:{"__strlit0":"123%"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((n0.properties ->> 'name') like @__strlit0::text)) select s0.n0 as s from s0;

-- case: match (s) where not s.name starts with '123' return s
-- pgsql_params:{"__strlit0":"","__strlit1":"123%"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not coalesce((n0.properties ->> 'name'), @__strlit0::text)::text like @__strlit1::text)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_starts_with((n0.properties ->> 'name'), (n0.properties ->> 'other'))::bool)) select s0.n0 as s from s0;

-- case: match (s) where s.name contains s.other return s
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_contains((n0.properties ->> 'name'), (n0.properties ->> 'other'))::bool)) select s0.n0 as s from s0;

-- case: match (s) where s.name ends with s.other return s
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_ends_with((n0.properties ->> 'name'), (n0.properties ->> 'other'))::bool)) select s0.n0 as s from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (n0.kind_ids operator (pg_catalog.@>) array [1]::int2[] and lower((n0.properties ->> 'tenantid'))::text like @__strlit0::text and (n0.properties ->> 'system_tags') like @__strlit1::text)) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0) select s0.n0 as s from s0 where (not (with s1 as (select s0.n0 as n0 from edge e0 join node n1 on (jsonb_typeof((n1.properties -> 'name')) = @__strlit0::text and (n1.properties ->> 'name') = @__strlit1::text) and (n1.id = e0.end_id or n1.id = e0.start_id) where ((s0.n0).id <> n1.id) and (jsonb_typeof((e0.properties -> 'prop')) = @__strlit0::text and (e0.properties ->> 'prop') = @__strlit2::text) and ((s0.n0).id = e0.end_id or (s0.n0).id = e0.start_id)) select count(*) > 0 from s1));

-- case: match (s) where not (s)<-[{prop: 'a'}]-({name: 'n3'}) return s
-- pgsql_params:{"__strlit0":"string","__strlit1":"n3","__strlit2":"a"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0) select s0.n0 as s from s0 where (not (with s1 as (select s0.n0 as n0 from edge e0 join node n1 on (jsonb_typeof((n1.properties -> 'name')) = @__strlit0::text and (n1.properties ->> 'name') = @__strlit1::text) and n1.id = e0.start_id where (jsonb_typeof((e0.properties -> 'prop')) = @__strlit0::text and (e0.properties ->> 'prop') = @__strlit2::text) and (s0.n0).id = e0.end_id) select count(*) > 0 from s1));

-- case: match (n:NodeKind1) where n.distinguishedname = toUpper('admin') return n
-- pgsql_params:{"__strlit0":"string","__strlit1":"admin"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((jsonb_typeof((n0.properties -> 'distinguishedname')) = @__strlit0::text and (n0.properties ->> 'distinguishedname') = upper(@__strlit1::text)::text)) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;

-- case: match (n:NodeKind1) where n.distinguishedname starts with toUpper('admin') return n
-- pgsql_params:{"__strlit0":"admin"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_starts_with((n0.properties ->> 'distinguishedname'), (upper(@__strlit0::text)::text)::text)::bool) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;

-- case: match (n:NodeKind1) where n.distinguishedname contains toUpper('admin') return n
-- pgsql_params:{"__strlit0":"admin"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_contains((n0.properties ->> 'distinguishedname'), (upper(@__strlit0::text)::text)::text)::bool) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;

-- case: match (n:NodeKind1) where n.distinguishedname ends with toUpper('admin') return n
-- pgsql_params:{"__strlit0":"admin"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_ends_with((n0.properties ->> 'distinguishedname'), (upper(@__strlit0::text)::text)::text)::bool) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;

-- case: match (s) where not (s)-[{prop: 'a'}]->({name: 'n3'}) return s
-- pgsql_params:{"__strlit0":"string","__strlit1":"n3","__strlit2":"a"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0) select s0.n0 as s from s0 where (not (with s1 as (select s0.n0 as n0 from edge e0 join node n1 on (jsonb_typeof((n1.properties -> 'name')) = @__strlit0::text and (n1.properties ->> 'name') = @__strlit1::text) and n1.id = e0.end_id where (jsonb_typeof((e0.properties -> 'prop')) = @__strlit0::text and (e0.properties ->> 'prop') = @__strlit2::text) and (s0.n0).id = e0.start_id) select count(*) > 0 from s1));
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not cypher_contains(coalesce((n0.properties ->> 'system_tags'), @__strlit0::text)::text, (@pi0)::text)::bool)) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (cypher_ends_with((n0.properties ->> 'system_tags'), (@__strlit0::text)::text)::bool)) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where ((n0.properties ->> 'functionallevel') = any (array [@__strlit0::text, @__strlit1::text, @__strlit2::text, @__strlit3::text, @__strlit4::text, @__strlit5::text]::text[])) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (coalesce((n0.properties ->> 'system_tags'), @__strlit0::text)::text like @__strlit1::text) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties -> 'hasspn'))::jsonb = to_jsonb((true)::bool)::jsonb and ((n0.properties -> 'enabled'))::jsonb = to_jsonb((true)::bool)::jsonb and not cypher_ends_with((@__strlit0::text)::text, coalesce((n0.properties ->> 'objectid'), @__strlit1::text)::text)::bool and not coalesce(((n0.properties ->> 'gmsa'))::bool, false)::bool = true and not coalesce(((n0.properties ->> 'msa'))::bool, false)::bool = true) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as u from s0 limit 10;

-- case: match (n:NodeKind1) where coalesce(n.name, '') = coalesce(n.migrated_name, '') return n
-- pgsql_params:{"__strlit0":""}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (coalesce((n0.properties ->> 'name'), @__strlit0::text)::text = coalesce((n0.properties ->> 'migrated_name'), @__strlit0::text)::text) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;

-- case: match (n:NodeKind1) where '1' in n.array_prop + ['1', '2'] return n
-- pgsql_params:{"__strlit0":"1","__strlit1":"2"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (@__strlit0::text = any (jsonb_to_text_array((n0.properties -> 'array_prop'))::text[] || array [@__strlit0::text, @__strlit1::text]::text[])) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as n from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (@__strlit0::text = any (jsonb_to_text_array((n0.properties -> 'arrayProperty'))::text[]) or @__strlit1::text = any (jsonb_to_text_array((n0.properties -> 'arrayProperty'))::text[]) or @__strlit2::text = any (jsonb_to_text_array((n0.properties -> 'arrayProperty'))::text[])) and n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]) select s0.n0 as u from s0;
...
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1 where ((n1.properties ->> 'distinguishedname') = @__strlit0::text || ((s0.n0).properties ->> 'distinguishedname')) and n1.kind_ids operator (pg_catalog.@>) array [2]::int2[]) select s1.n1 as m from s1;
...
-- pgsql_params:{"__strlit0":"CN=ADMINSDHOLDER,CN=SYSTEM,"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1 where ((n1.properties ->> 'distinguishedname') = ((s0.n0).properties ->> 'distinguishedname') || @__strlit0::text) and n1.kind_ids operator (pg_catalog.@>) array [2]::int2[]) select s1.n1 as m from s1;
...
-- pgsql_params:{"__strlit0":"1","__strlit1":"2"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where n0.kind_ids operator (pg_catalog.@>) array [1]::int2[]), s1 as (select s0.n0 as n0, (n1.id, n1.kind_ids, n1.properties)::nodecomposite as n1 from s0, node n1 where ((n1.properties ->> 'distinguishedname') = @__strlit0::text || @__strlit1::text) and n1.kind_ids operator (pg_catalog.@>) array [2]::int2[]) select s1.n1 as m from s1;

-- case: match (n) where not n.property is not null return n
-- pgsql_params:{"__strlit0":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not (n0.properties ? 'property' and not (n0.properties -> 'property') = (@__strlit0::text)::jsonb))) select s0.n0 as n from s0;

-- case: match (s) where s.prop = [] return s
-- pgsql_params:{"__strlit0":"[]","__strlit1":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties -> 'prop') = (@__strlit0::text)::jsonb or (n0.properties -> 'prop') = (@__strlit1::text)::jsonb and null))) select s0.n0 as s from s0;
...
-- pgsql_params:{"__strlit0":"[]","__strlit1":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not ((n0.properties -> 'prop') != (@__strlit0::text)::jsonb and (n0.properties -> 'prop') != (@__strlit1::text)::jsonb or (n0.properties -> 'prop') = (@__strlit1::text)::jsonb and null))) select s0.n0 as s from s0;

-- case: match (s) where not s.prop = [] return s
-- pgsql_params:{"__strlit0":"[]","__strlit1":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (not ((n0.properties -> 'prop') = (@__strlit0::text)::jsonb or (n0.properties -> 'prop') = (@__strlit1::text)::jsonb and null))) select s0.n0 as s from s0;

-- case: match (s) where s.prop <> [] return s
-- pgsql_params:{"__strlit0":"[]","__strlit1":"null"}
with s0 as (select (n0.id, n0.kind_ids, n0.properties)::nodecomposite as n0 from node n0 where (((n0.properties -> 'prop') != (@__strlit0::text)::jsonb and (n0.properties -> 'prop') != (@__strlit1::text)::jsonb or (n0.properties -> 'prop') = (@__strlit1::text)::jsonb and null))) select s0.n0 as s from s0;
