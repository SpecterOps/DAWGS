...
func postgresIndexType(indexType v2.IndexType) string {
	switch indexType {
...
func parsePostgresIndexType(pgType string) v2.IndexType {
...
func formatCreatePropertyConstraint(constraintName, tableName, fieldName string, indexType v2.IndexType) string {
...
func formatCreatePropertyIndex(indexName, tableName, fieldName string, indexType v2.IndexType) string {
	var (
		pgIndexType  = postgresIndexType(indexType)
	...
	if indexType == v2.IndexTypeTextSearch {
