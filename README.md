...
- [Hash-filtered ingest architecture](docs/postgresql_ingest_architecture.md): the technology-neutral philosophy and core concepts behind bounded, replayable hash-filtered ingest.
- [PostgreSQL hash-filtered ingest](docs/postgresql_ingest.md): current PostgreSQL-only API, data contract, operational guidance, and manual benchmarks.
