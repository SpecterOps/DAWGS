...
PID, transaction, or context. The v2 key adds a cache-format version and monotonic schema generation to the v1
translation inputs. Successful `AssertSchema` and `RefreshKinds` calls advance that generation, making old entries
